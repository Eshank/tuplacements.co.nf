...
if(isset($_GET['x']))
{
	echo '<form method="post" action="quizx.php';
	echo '?x='.$_GET['x'];
	echo '">';
	...
	if($_GET['x']==1)
		...
		$sql = "select * from dbms_ques where id between 3 and 4";
	else if($_GET['x']==3)
		$sql = "select * from dbms_ques where id=5";
	else if($_GET['x']==4)
		$sql = "select * from dbms_ques where id=6";
	else if($_GET['x']==5)
		$sql = "select * from dbms_ques where id=7";
	else if($_GET['x']==6)
		$sql = "select * from dbms_ques where id=8";
	$query = mysqli_query($conn, $sql);
	while($row = mysqli_fetch_array($query))
	{
		echo '<div style="color:#2c3e50;font-size:20px;font-weight:bold;">QUES NO '.$i.''.$row['question'].'</div> ';
		$sql2 = "select * from dbms_options where id=".$row['id'];
...
= false }">';
		echo '<label style="cursor:default;">'.$row2['optionA'].'</label>';
		$count=0;
		if(isset($_POST['submit']))
		{
			if(isset($_POST[$i]))
			{
				if($_POST[$i]=='A')
				{
					$sql3 = "select * from dbms_ans where id=".$row['id'];
...
= false }">';
	...
	if($_GET['x']==1)
		$sql = "select * from ds_ques where id between 1 and 5";
	else if($_GET['x']==2)
		$sql = "select * from ds_ques where id between 6 and 10";
	else if($_GET['x']==3)
		$sql = "select * from ds_ques where id between 11 and 15";
	else if($_GET['x']==4)
		$sql = "select * from ds_ques where id between 16 and 20";
	else if($_GET['x']==5)
		$sql = "select * from ds_ques where id between 21 and 25";
	else if($_GET['x']==6)
		$sql = "select * from ds_ques where id between 26 and 29";
	$query = mysqli_query($conn, $sql);
	while($row = mysqli_fetch_array($query))
	{
		echo '<div style="color:#5ac90e;font-size:20px;font-weight:bold;">QUES NO '.$i;
		echo $row['question'].'</div>';
		$sql2 = "select * from ds_options where id=".$row['id'];
		$query2 = mysqli_query($conn, $sql2);	
		$row2 = mysqli_fetch_array($query2);
		echo '<input type="radio" name="'.$i.'" value="A" style="width:30px;cursor:pointer;" onmousedown="this.c=this.checked" onclick="if (this.c) { this.checked
= false }">';
		...
		if(isset($_POST['submit']))
		{
			if(isset($_POST[$i]))
			{
				if($_POST[$i]=='A')
				{
					$sql3 = "select * from ds_ans where id=".$row['id'];
					$query3 = mysqli_query($conn, $sql3);	
					$row3 = mysqli_fetch_array($query3);
					if($_POST[$i]==$row3['answer'])
					{
...
= false }">';
	...
	if($_GET['x']==1)
		$sql = "select * from nw_ques where id between 1 and 4";
	else if($_GET['x']==2)
		$sql = "select * from nw_ques where id between 5 and 8";
	else if($_GET['x']==3)
		$sql = "select * from nw_ques where id between 9 and 13";
	else if($_GET['x']==4)
		$sql = "select * from nw_ques where id between 14 and 18";
	else if($_GET['x']==5)
		$sql = "select * from nw_ques where id between 19 and 22";
	else if($_GET['x']==6)
		$sql = "select * from nw_ques where id between 23 and 26";
	$query = mysqli_query($conn, $sql);
	while($row = mysqli_fetch_array($query))
	{
		echo '<div style="color:#5ac90e;font-size:20px;font-weight:bold;">QUES NO '.$i;
		echo $row['question'].'</div>';
		$sql2 = "select * from nw_options where id=".$row['id'];
		$query2 = mysqli_query($conn, $sql2);	
		$row2 = mysqli_fetch_array($query2);
		echo '<input type="radio" name="'.$i.'" value="A" style="width:30px;cursor:pointer;" onmousedown="this.c=this.checked" onclick="if (this.c) { this.checked
= false }">';
		...
		if(isset($_POST['submit']))
		{
			if(isset($_POST[$i]))
			{
				if($_POST[$i]=='A')
				{
					$sql3 = "select * from nw_ans where id=".$row['id'];
					$query3 = mysqli_query($conn, $sql3);	
					$row3 = mysqli_fetch_array($query3);
					if($_POST[$i]==$row3['answer'])
					{
...
= false }">';
	...
	if($_GET['x']==1)
		$sql = "select * from os_ques where id between 1 and 5";
	else if($_GET['x']==2)
		$sql = "select * from os_ques where id between 6 and 10";
	else if($_GET['x']==3)
		$sql = "select * from os_ques where id between 11 and 15";
	else if($_GET['x']==4)
		$sql = "select * from os_ques where id between 16 and 20";
	else if($_GET['x']==5)
		$sql = "select * from os_ques where id between 21 and 25";
	else if($_GET['x']==6)
		$sql = "select * from os_ques where id between 26 and 30";
	$query = mysqli_query($conn, $sql);
	while($row = mysqli_fetch_array($query))
	{
		echo '<div style="color:#5ac90e;font-size:20px;font-weight:bold;">QUES NO '.$i;
		echo $row['question'].'</div>';
		$sql2 = "select * from os_options where id=".$row['id'];
		$query2 = mysqli_query($conn, $sql2);	
		$row2 = mysqli_fetch_array($query2);
		echo '<input type="radio" name="'.$i.'" value="A" style="width:30px;cursor:pointer;" onmousedown="this.c=this.checked" onclick="if (this.c) { this.checked
= false }">';
		...
		if(isset($_POST['submit']))
		{
			if(isset($_POST[$i]))
			{
				if($_POST[$i]=='A')
				{
					$sql3 = "select * from os_ans where id=".$row['id'];
					$query3 = mysqli_query($conn, $sql3);	
					$row3 = mysqli_fetch_array($query3);
					if($_POST[$i]==$row3['answer'])
					{
...
if($_GET['x']==1)
		$sql = "select * from c where id between 1 and 4";
	else if($_GET['x']==2)
		$sql = "select * from c where id between 5 and 8";
	else if($_GET['x']==3)
		$sql = "select * from c where id between 9 and 12";
	else if($_GET['x']==4)
		$sql = "select * from c where id between 13 and 16";
	else if($_GET['x']==5)
		$sql = "select * from c where id between 17 and 21";
	else if($_GET['x']==6)
		$sql = "select * from c where id between 22 and 27";
	$query = mysqli_query($conn, $sql);
	while($row = mysqli_fetch_array($query))
	{
		echo '<div style="color:#5ac90e;font-size:20px;font-weight:bold;">QUES NO '.$i;
